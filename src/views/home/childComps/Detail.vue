<template>
  <div class="detail">
    <product-params v-bind:title="product.name"></product-params>
    <div class="wrapper">
      <div class="container clearfix">
        <div class="swiper">
          <swiper :options="swiperOption">
            <swiper-slide>
              <img src="/img/detail/phone-1.jpg" alt />
            </swiper-slide>
            <swiper-slide>
              <img src="/img/detail/phone-2.jpg" alt />
            </swiper-slide>
            <swiper-slide>
              <img src="/img/detail/phone-3.jpg" alt />
            </swiper-slide>
            <swiper-slide>
              <img src="/img/detail/phone-4.jpg" alt />
            </swiper-slide>
            <!-- Optional controls -->
...
export default {
  components: { ProductParams, ServiceBar },
  name: 'Detail',
  data() {
    return {
    ...
    .content
      ...
      .item-addr
        ...
        .icon-loc
          ...
          top  27px;
          left  34px;
          iconStyle('~assets/icon/icon-loc.png')
          width 20px
          height 20px
        .addr
          color #666666;
